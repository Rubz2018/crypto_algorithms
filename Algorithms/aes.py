...
class AESCipher :
    ...
    def encrypt(self, plain_text):
        ...
        # IV (Initialization Vector/ Seed) even we use the same key and plain text the result will be different
...
if __name__ == '__main__':
    aes = AESCipher('Rubaiyat Islam')
    message = 'This is a secret message from Dr. Rubaiyat Islam'
